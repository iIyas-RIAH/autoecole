            <?php
            if ($ligne441[1]=='matin') {
                $resultat41 = mysqli_query($connexion, "SELECT typeformation, dateseance FROM moniteur, seance WHERE seance.CINMoniteur='$CINMoniteur' and dateseance='$ligne100[0]' and horaire='matin';");
            ...
            ?>
                    <tr align="center">
                        ...
                        <td height="45px" style="vertical-align: middle;"><?php echo $ligne41[0]; ?></td>
            ...
            ?>
                    <tr align="center">
                        <td height="45px"><?php echo $ligne41[1]; ?></td>
                        <td height="45px"><?php echo $ligne41[0]."<br>".$ligne41[2]." ".$ligne41[3]; ?></td>
                        <td style="background: #6a6a6a"></td>
                        <td height="45px" style="vertical-align: middle;"><?php echo $ligne41[0]; ?></td>
                    </tr>
