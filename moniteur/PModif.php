...
if(isset($_POST['submit']))
{
    ...
    $resultat = mysqli_fetch_row(mysqli_query($connexion, "SELECT motdepasse FROM Moniteur WHERE CINMoniteur='$CINMoniteur'"));
    if ($motdepasse0=='' && $motdepasse1=='' && $motdepasse2=='') {
      $query_run = mysqli_query($connexion, "UPDATE Moniteur SET nom='$nom', prenom='$prenom', telephone='$telephone', email='$email' WHERE CINMoniteur='$CINMoniteur'");
      header('Location: Profil.php');
    }else if ($resultat[0] == $motdepasse0 && $motdepasse1==$motdepasse2) {
      $query_run = mysqli_query($connexion, "UPDATE Moniteur SET nom='$nom', prenom='$prenom', telephone='$telephone', email='$email', motdepasse='$motdepasse1' WHERE CINMoniteur='$CINMoniteur'");
      header('Location: Profil.php');
    }
}
?>
...
<head>
  ...
  <title>Moniteur | Modifier votre profil</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" style="padding-top: 25px;">
          ...
          <div class="card shadow mb-4">
            ...
            <?php
                $CINMoniteur = $_SESSION['CINMoniteur'];
                $resultat = mysqli_query($connexion, "SELECT nom, prenom, email, telephone FROM Moniteur WHERE CINMoniteur='$CINMoniteur'");
