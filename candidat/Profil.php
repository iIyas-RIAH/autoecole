    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          $resultat = mysqli_fetch_row(mysqli_query($connexion, "SELECT * FROM candidat WHERE CINCandidat='$CINCandidat'"));
          if($resultat)
          {
        ?>
      <span style="font-size: 26px;">Bienvenue <?php echo $resultat[1]." ".$resultat[2]; }?></span>
        ...
        <div class="container-fluid" style="padding-top: 45px;">
          ...
          <div class="card shadow mb-4">
            ...
            <?php
                $resultat = mysqli_query($connexion, "SELECT * FROM Candidat WHERE CINCandidat='$CINCandidat'");
