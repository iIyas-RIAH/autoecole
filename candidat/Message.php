...
<head>
  ...
  <title>Candidat | Messagerie</title>
        ...
        <div class="container-fluid" style="padding-top: 45px; width: 75%;">
          ...
          <div class="card shadow mb-4">
            ...
            <?php
                ...
                $resultat = mysqli_query($connexion, "SELECT * FROM message where Destinataire=(SELECT class FROM Candidat where CINCandidat='$CINCandidat') order by DATE");
            ...
            <?php
                $resultat1 = mysqli_query($connexion, "SELECT DISTINCT CINMoniteur FROM Candidat, Seance where Candidat.class=Seance.class");
                while ($ligne1 = mysqli_fetch_row($resultat1)) {
                  $resultat2 = mysqli_query($connexion, "SELECT DISTINCT CINMoniteur, nom, prenom FROM Moniteur where CINMoniteur='$ligne1[0]'");
