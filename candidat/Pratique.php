<?php
                $resultat41 = mysqli_query($connexion, "SELECT typeformation, nom, prenom, dateseance, marque, type, idseance FROM vehicule, moniteur, seance WHERE seance.matricule=vehicule.matricule AND seance.CINMoniteur=moniteur.CINMoniteur and dateseance='$ligne100[0]' and class='$abc' and horaire='matin';");
            ...
            ?>
                    <tr align="center">
                        ...
                        <td height="45px"><?php echo $ligne41[1]." ".$ligne41[2]."<br>".$ligne41[0]."<br>".$ligne42[4]." ".$ligne42[5]; ?></td>
