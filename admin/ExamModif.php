...
{
    $id = $_GET['modifier_idexamen'];
    $dateE = $_POST['dateE'];
    $typeExam = $_POST['typeExam'];
    $resultatExam = $_POST['resultatExam'];
    $CIN = $_POST['CIN'];
    $query_run = mysqli_query($connexion, "UPDATE Examen SET dateexamen='$dateE', typeexamen='$typeExam' WHERE idexamen='$id'");
    $query_run1 = mysqli_query($connexion, "UPDATE avoir SET resultatexamen='$resultatExam' WHERE CINCandidat='$CIN'and idexamen='$id'");
...
<head>
  ...
  <title>Admin | Modifier un examen</title>
        ...
        <div class="container-fluid" style="padding-top: 25px;">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h5 class="m-0 font-weight-bold text-primary">Modifier un Examen</h5>
            </div>
            <div class="card-body">
            ...
            <?php
                $id = $_GET['modifier_idexamen'];
                $resultat1 = mysqli_query($connexion, "SELECT CINCandidat, nom, prenom FROM Candidat");
                $resultat2 = mysqli_query($connexion, "SELECT distinct typeexamen FROM Examen");
                $resultat = mysqli_query($connexion, "SELECT examen.idexamen, examen.dateexamen, avoir.RESULTATEXAMEN FROM Examen INNER JOIN avoir on examen.idexamen=avoir.idexamen and examen.idexamen='$id' INNER JOIN Candidat on Candidat.CINCandidat=avoir.CINCandidat");
        ...
        <form class="form__inner" method="post" accept-charset="utf-8">
          <div class="form__line" style="margin-top: 15px;">
            <div class="form__block">
              <h4 class="form__label">Date d'examen</h4>
              <input class="form__input" class="date" type="text" name="dateE" value="<?php echo $ligne[1]; ?>" required>
            </div>
          </div>
          <div class="form__line"  style="margin-top: 15px;">
            <div class="form__block">
              <h4 class="form__label">Type d'examen</h4>
              <select class="form__input" name="typeExam" required>
            <?php 
          ...
          <div class="form__line" style="margin-top: 15px;">
            <div class="form__block">
              <h4 class="form__label">Résultat d'examen</h4>
              <input class="form__input" type="text" name="resultatExam" value="<?php echo $ligne[2]; ?>" required>
            </div>
          </div>
          <div class="form__line" style="margin-top: 15px;">
            <div class="form__block">
              <h4 class="form__label">Candidat</h4>
