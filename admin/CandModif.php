...
{
    $CIN = $_GET['modifier_CINCandidat'];
    $nom = strtoupper($_POST['nom']);
    $prenom = $_POST['prenom'];
    $dateN = $_POST['dateN'];
    $telephone = $_POST['mobile'];
    $email = $_POST['email'];
    $motdepasse = $_POST['passwd1'];
    $motdepasse2 = $_POST['passwd2'];
    $class = $_POST['class'];
    if ($motdepasse==$motdepasse2) {
      $query_run = mysqli_query($connexion, "UPDATE Candidat SET nom='$nom', prenom='$prenom', datenaissance='$dateN', telephone='$telephone', email='$email', class='$class', motdepasse='$motdepasse' WHERE CINCandidat='$CIN'");
...
<head>
  ...
  <title>Admin | Modifier un candidat</title>
        ...
        <div class="container-fluid" style="padding-top: 25px;">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h5 class="m-0 font-weight-bold text-primary">Modifier un Candidat</h5>
            </div>
            <div class="card-body">
            ...
            <?php
                $CIN = $_GET['modifier_CINCandidat'];
                $resultat = mysqli_query($connexion, "SELECT nom, prenom, datenaissance, telephone, email, class, motdepasse FROM Candidat WHERE CINCandidat='$CIN'");
        ...
        <form class="form__inner" method="post" accept-charset="utf-8">
          ...
          <div class="form__line" style="margin-top: 15px;">
            ...
            <div class="form__block">
              ...
              <input class="form__input" type="text" name="class" value="<?php echo $ligne[5]; ?>" required>
            </div>
          </div>
          <div class="form__line" style="margin-top: 15px;">
            <div class="form__block">
              <h4 class="form__label">Mot de passe</h4>
              <input class="form__input" type="password" name="passwd1" value="<?php echo $ligne[6]; ?>" required>
            </div>
            <div class="form__block">
              <h4 class="form__label">Confirmer le mot de passe</h4>
              <input class="form__input" type="password" name="passwd2" value="<?php echo $ligne[6]; ?>" required>
            </div>
          </div>
