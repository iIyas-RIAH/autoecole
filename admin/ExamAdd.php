...
if(isset($_POST['submit']))
{
    ...
    $CIN = $_POST['CIN'];
    $query_run = mysqli_query($connexion, "INSERT INTO Examen (dateexamen, typeexamen) VALUES ('$dateE', '$typeExam')");
    $query_run = mysqli_query($connexion, "INSERT INTO avoir (CINCandidat) VALUES ('$CIN')");
...
<head>
  ...
  <title>Admin | Ajouter un examen</title>
        ...
        <div class="container-fluid" style="padding-top: 25px;">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h5 class="m-0 font-weight-bold text-primary">Ajouter un Examen</h5>
            </div>
            <div class="card-body">
        ...
        <form class="form__inner" method="post" accept-charset="utf-8">
          <div class="form__line" style="margin-top: 15px;">
            <div class="form__block">
              ...
              <input class="form__input" class="date" type="date" name="dateE" required>
            </div>
          </div>
          <div class="form__line"  style="margin-top: 15px;">
            <div class="form__block">
              <h4 class="form__label">Type d'examen</h4>
              <input class="form__input" type="text" name="typeExam" required>
            </div>
          </div>
          <div class="form__line" style="margin-top: 15px;">
            <div class="form__block">
              <h4 class="form__label">Candidat</h4>
              <select class="form__input" name="CIN">
            <?php 
                $resultat = mysqli_query($connexion, "SELECT CINCandidat, nom, prenom FROM Candidat");
