...
if(isset($_POST['submit']))
{
    ...
    if ($motdepasse==$motdepasse2) {
      $query_run = mysqli_query($connexion, "UPDATE Moniteur SET nom='$nom', prenom='$prenom', telephone='$telephone', email='$email', motdepasse='$motdepasse' WHERE CINMoniteur='$CIN'");
...
<head>
  ...
  <title>Admin | Modifier un moniteur</title>
        ...
        <div class="container-fluid" style="padding-top: 25px;">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h5 class="m-0 font-weight-bold text-primary">Modifier un Moniteur</h5>
            </div>
            <div class="card-body">
            ...
            <?php
                $CIN = $_GET['modifier_CINMoniteur'];
                $resultat = mysqli_query($connexion, "SELECT nom, prenom, email, telephone, motdepasse FROM Moniteur WHERE CINMoniteur='$CIN'");
        ...
        <form class="form__inner" method="post" accept-charset="utf-8">
          ...
          <div class="form__line"  style="margin-top: 15px;">
            <div class="form__block">
              ...
              <input class="form__input" type="text" name="email" value="<?php echo $ligne[2]; ?>" required>
            </div>
            <div class="form__block">
          ...
          <div class="form__line" style="margin-top: 15px;">
            <div class="form__block">
              ...
              <input class="form__input" type="password" name="passwd1" value="<?php echo $ligne[4]; ?>" required>
            </div>
            <div class="form__block">
              <h4 class="form__label">Confirmer le mot de passe</h4>
              <input class="form__input" type="password" name="passwd2" value="<?php echo $ligne[4]; ?>" required>
            </div>
          </div>
