...
<head>
  ...
  <title>Admin | Table des séances</title>
  ...
  <script>
          function modifier(modifier)
          {
              ...
              {
                  window.location.href='SeanModif.php?modifier_idseance=' +modifier;
              }
          }
          function supprimer(supprimer)
          {
              ...
              {
                  window.location.href='SeanSupp.php?supprimer_idseance=' +supprimer;
              }
          }
          function add()
          {
              ...
              {
                  window.location.href='SeanAdd.php';
              }
          }
  </script>
</head>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <?php
                include('sean.php');    
              ?>
                <div style="display: flex; justify-content: center; padding-bottom: 4px;"><span style="padding-right: 15px;">Ajouter une séance</span><button type="submit" name="ajout" title="Ajouter" onClick="add()"><img src="../img/add.png" width="20px" height="23px"></button></div>
              </div>
            </div>
          </div>
        </div>
