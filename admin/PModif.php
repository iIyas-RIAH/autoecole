...
{
    $login = $_GET['modifier_login'];
    $motdepasse0 = $_POST['passwd0'];
    $motdepasse1 = $_POST['passwd1'];
    $motdepasse2 = $_POST['passwd2'];
    $resultat = mysqli_fetch_row(mysqli_query($connexion, "SELECT motdepasse FROM admin WHERE login='$login'"));
    if ($resultat[0] == $motdepasse0 && $motdepasse1 == $motdepasse2) {
      $query_run = mysqli_query($connexion, "UPDATE admin SET motdepasse='$motdepasse1' WHERE login='$login'");
...
<head>
  ...
  <title>Admin | Modifier votre profil</title>
        ...
        <form class="form__inner" method="post" accept-charset="utf-8">
          <div class="form__line" style="margin-top: 15px;">
            <div class="form__block">
              ...
              <input class="form__input" type="password" name="passwd0" required>
            </div>
          </div>
          <div class="form__line"  style="margin-top: 15px;">
            <div class="form__block">
              <h4 class="form__label">Le nouveau mot de passe</h4>
              <input class="form__input" type="password" name="passwd1" required>
            </div>
          </div>
          <div class="form__line" style="margin-top: 15px;">
            <div class="form__block">
