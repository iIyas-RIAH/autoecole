...
{
    $CIN = $_POST['CIN'];
    $query_run = mysqli_query($connexion, "INSERT INTO codeae (cin_ae) VALUES ('$CIN')");
...
<head>
  ...
  <title>Admin | Ajouter un CIN</title>
        ...
        <div class="container-fluid" style="padding-top: 25px;">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h5 class="m-0 font-weight-bold text-primary">Ajouter un CIN</h5>
            </div>
            <div class="card-body">
