...
{
    $id = $_GET['modifier_codeae'];
    $CIN = $_POST['CIN'];
    $query_run = mysqli_query($connexion, "UPDATE codeae SET cin_ae='$CIN' WHERE id='$id'");
...
<head>
  ...
  <title>Admin | Modifier un CIN</title>
        ...
        <div class="container-fluid" style="padding-top: 25px;">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h5 class="m-0 font-weight-bold text-primary">Modifier un CIN</h5>
            </div>
            <div class="card-body">
        ...
        <form class="form__inner" method="post" accept-charset="utf-8">
          <div class="form__line" style="margin-top: 15px;">
            <div class="form__block">
              <h4 class="form__label">Nouveau CIN</h4>
              <input class="form__input" type="text" name="CIN" required>
            </div>
          </div>
