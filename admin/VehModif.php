...
{
    $id = $_GET['modifier_idvehicule'];
    $matricule = $_POST['matricule'];
    $marque = $_POST['marque'];
    $typeV = $_POST['typeVeh'];
    $query_run = mysqli_query($connexion, "UPDATE Vehicule SET matricule='$matricule', marque='$marque', type='$typeV' WHERE idvehicule='$id'");
...
<head>
  ...
  <title>Admin | Modifier un Vehicule</title>
        ...
        <div class="container-fluid" style="padding-top: 25px;">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h5 class="m-0 font-weight-bold text-primary">Modifier un Vehicule</h5>
            </div>
            <div class="card-body">
            ...
            <?php
                $id = $_GET['modifier_idvehicule'];
                $resultat = mysqli_query($connexion, "SELECT * FROM Vehicule WHERE idvehicule='$id'");
        ...
        <form class="form__inner" method="post" accept-charset="utf-8">
          <div class="form__line" style="margin-top: 15px;">
            <div class="form__block">
              ...
              <input class="form__input" type="text" name="matricule" value="<?php echo $ligne[1]; ?>" required>
            </div>
          </div>
          <div class="form__line"  style="margin-top: 15px;">
            <div class="form__block">
              <h4 class="form__label">Marque</h4>
              <input class="form__input" type="text" name="marque" value="<?php echo $ligne[2]; ?>" required>
            </div>
          </div>
          <div class="form__line" style="margin-top: 15px;">
            <div class="form__block">
              <h4 class="form__label">Type</h4>
              <input class="form__input" type="text" name="typeVeh" value="<?php echo $ligne[3]; ?>" required>
            </div>
          </div>
